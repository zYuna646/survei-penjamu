...
class UserProdi  implements FromCollection, WithHeadings, WithStyles
{
    /**
    ...
    */
    public function collection()
    {
        ...
        $role = Role::where('slug', 'prodi')->first();
        ...
        return $users->map(function ($user) {
            return [
                'email' => $user->email,
                'fakultas' => $user->prodi->name ?? 'N/A', // Ensure 'fakultas' relationship exists
                'password' => $user->name,
            ];
        });
    }
