...
">
    ...
    <section class="max-w-screen-xl w-full mx-auto px-4 mt-4 pb-12" x-data="{ userRole: '{{ $user->role->slug }}' }">
        ...
        <div x-if="userRole === 'universitas'" class="flex flex-col gap-y-2 mb-4"
            ...
            <div x-show="expand" x-transition style="display: none"
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <x-button color="default" size="sm" @click="addUniversitasSolusi = !addUniversitasSolusi">
                        Buat Solusi
                    </x-button>
                    @else
            ...
            <div x-show="addUniversitasSolusi" style="display: none"
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full" @click.outside="addUniversitasSolusi = false">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow ">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            <form wire:submit.prevent="addSolusi({{ $item->id }})" class="grid grid-cols-12 p-2">
                                <div class="flex flex-col gap-y-2 col-span-12 mb-4">
                                    ...
                                    @error('solusi') <span class="text-red-500 text-xs">{{ $message
                                        }}</span>
                                    @enderror
                                </div>
        ...
        <div x-if="userRole === 'fakultas'" class="flex flex-col gap-y-2 mb-4"
            ...
            <div x-show="expand" x-transition style="display: none"
                ...
                <div class="flex flex-col items-center justify-center">
                    @if (is_null($item->solusi))
                    <span class="text-sm italic py-4 font-semibold">- Solusi belum tersedia -</span>
                    <x-button color="default" size="sm" @click="addFakultasSolusi = !addFakultasSolusi">
                        Buat Solusi
                    </x-button>
                    @else
                    <div class="w-full p-4 flex flex-col gap-y-2 rounded-md border border-color-info-500">
            ...
            {{-- add fakultas solusi --}}
            <div x-show="addFakultasSolusi" style="display: none" x-on:keydown.escape.window="addFakultasSolusi = false"
                class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-full max-h-full bg-black/20">
                <div class="relative p-4 w-full max-w-2xl max-h-full" @click.outside="addFakultasSolusi = false">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow ">
                        <!-- Modal header -->
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
        ...
        <div x-if="userRole === 'prodi'" class="flex flex-col gap-y-2 mb-4"
                ...
                <div class="flex flex-col gap-y-2">
                    <div class="w-full inline-flex justify-between items-center">
                        ...
                        <div class="inline-flex text-slate-500 gap-x-2 items-center">
                            ...
                            <span class="text-xs font-semibold">{{ $item->prodi->name }} , {{ $item->created_at
                                }}</span>
            ...
            {{-- add prodi solusi --}}
            <div x-show="addProdiSolusi" style="display: none" x-on:keydown.escape.window="addProdiSolusi = false"
                class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-full max-h-full bg-black/20">
